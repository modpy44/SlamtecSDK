...
namespace slamware_ros_sdk {
    ...
    {   bool is_valid = false;
        ...
        if(!is_valid) {msgScan.range_max = std::numeric_limits<float>::infinity() ; msgScan.range_min = 0.0f;  }
        if (std::abs(msgScan.range_min - msgScan.range_max) < 1e-9) { msgScan.range_min = msgScan.range_min - 0.000001;}
    }
